...
export const PALETTE_KEYS = Object.freeze(['clock', 'heart', 'numbers', 'waiting', 'awake', 'light_sleep', 'deep_sleep', 'unknown_sleep', 'battery', 'alarm', 'info', 'offline', 'heart_wait', 'battery_frame', 'battery_fill', 'battery_charge', 'battery_mid', 'battery_low', 'oxygen', 'oxygen_label', 'charging_text', 'battery_status', 'waiting_text', 'reconnect_text', 'setup_title']);
...
Object.assign(translations.de,{"color_numbers": "Pulswert", "color_oxygen_label": "O2-Beschriftung", "color_oxygen": "Sauerstoffwert und %", "color_charging_text": "Text „LAEDT“", "color_battery_status": "Text „SOCKE AUS“", "color_waiting": "O2 und Platzhalter „--“ / „--%“", "color_waiting_text": "Text „WARTE“", "color_reconnect_text": "Text „VERBINDE“", "color_setup_title": "Einrichtung: „OWLANZI“", "color_info": "Hinweise und Einrichtungstext", "color_awake": "Wach · Text und Balken", "color_light_sleep": "Leichtschlaf · Text und Balken", "color_deep_sleep": "Tiefschlaf · Text und Balken", "color_unknown_sleep": "Unbekannt · Fragezeichen und Balken", "vitalsColors": "Puls und Sauerstoff · obere Zeile", "sleepColors": "Schlafstatus · unten links", "batteryColors": "Akku und Ladeanzeige", "alarmColors": "Alarme, Hinweise und Einrichtung", "vitalsLayout": "Oben stehen Herz, Pulswert, O2 und Sauerstoffwert. Puls und Sauerstoff haben eigene Farben.", "sleepLayout": "Unten links zeigen Text und Balken gemeinsam den Schlafzustand. Wähle einen Zustand für die Vorschau.", "batteryLayout": "Das Akkusymbol und die Prozentzahl erscheinen unten rechts neben den Messwerten. Beim Laden oder bei ausgeschalteter Socke zeigt die Uhr die große Akkuanzeige.", "waitingLayout": "Ohne Messwerte erscheinen Herz, O2, Platzhalter und WARTE. Bei fehlender Verbindung stehen OFFLINE und VERBINDE auf der Uhr.", "alarmLayout": "Die gewählte Alarm- oder Hinweisfarbe gilt für beide Textzeilen. In der Einrichtung lassen sich OWLANZI und LOCAL SETUP getrennt färben.", "sockOffPreview": "Socke aus · 64 %", "batteryMidPreview": "Akku · 35 %", "batteryLowPreview": "Akku · 15 %", "setupPreview": "Einrichtung"});
Object.assign(translations.en,{"color_numbers": "Heart rate value", "color_oxygen_label": "O2 label", "color_oxygen": "Oxygen value and %", "color_charging_text": "CHARGING text", "color_battery_status": "SOCK OFF text", "color_waiting": "O2 and -- / --% placeholders", "color_waiting_text": "WAITING text", "color_reconnect_text": "RETRYING text", "color_setup_title": "Setup: OWLANZI", "color_info": "Notices and setup text", "color_awake": "Awake · text and bar", "color_light_sleep": "Light sleep · text and bar", "color_deep_sleep": "Deep sleep · text and bar", "color_unknown_sleep": "Unknown · question mark and bar", "vitalsColors": "Heart rate and oxygen · top row", "sleepColors": "Sleep state · bottom left", "batteryColors": "Battery and charging screen", "alarmColors": "Alarms, notices and setup", "vitalsLayout": "The top row shows the heart, heart rate, O2 and oxygen value. Heart rate and oxygen have separate colors.", "sleepLayout": "At the bottom left, text and a bar indicate the sleep state together. Select a state to preview it.", "batteryLayout": "The battery icon and percentage appear at the bottom right beside live readings. While charging or with the sock switched off, the clock shows the large battery screen.", "waitingLayout": "Without readings, the clock shows the heart, O2, placeholders and WAITING. When disconnected, it shows OFFLINE and RETRYING.", "alarmLayout": "The selected alarm or notice color applies to both text rows. In setup, OWLANZI and LOCAL SETUP have separate colors.", "sockOffPreview": "Sock off · 64%", "batteryMidPreview": "Battery · 35%", "batteryLowPreview": "Battery · 15%", "setupPreview": "Setup"});
